...
const GLchar* vertexShaderSource5 = "#version 330 core\n"
...
const GLchar* fragmentShaderSource5 = "#version 330 core\n"
                                      "in vec2 TexCoord;\n"
                                      "out vec4 color;\n"
...
void camera_advance()
{
    ...
    Shader ourShader(vertexShaderSource5, fragmentShaderSource5);
